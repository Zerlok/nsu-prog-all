...
Cylinder::Cylinder()
	: Mesh("Cylinder")
{
	static const Color color1 = Color::red;
	static const Color color2 = Color::blue;

	// vertices.
	{
	addVertex(Vertex(0.0, -1.0, 1.0, color2));
	addVertex(Vertex(0.0, 1.0, 1.0, color1));
	addVertex(Vertex(0.195, -1.0, 0.981, color2));
	addVertex(Vertex(0.195, 1.0, 0.981, color2));
	addVertex(Vertex(0.383, -1.0, 0.924, color2));
	addVertex(Vertex(0.383, 1.0, 0.924, color1));
	addVertex(Vertex(0.556, -1.0, 0.831, color1));
	addVertex(Vertex(0.556, 1.0, 0.831, color2));
	addVertex(Vertex(0.707, -1.0, 0.707, color1));
	addVertex(Vertex(0.707, 1.0, 0.707, color2));
	addVertex(Vertex(0.831, -1.0, 0.556, color1));
	addVertex(Vertex(0.831, 1.0, 0.556, color1));
	addVertex(Vertex(0.924, -1.0, 0.383, color2));
	addVertex(Vertex(0.924, 1.0, 0.383, color1));
	addVertex(Vertex(0.981, -1.0, 0.195, color2));
	addVertex(Vertex(0.981, 1.0, 0.195, color2));
	addVertex(Vertex(1.0, -1.0, 0.0, color2));
	addVertex(Vertex(1.0, 1.0, 0.0, color1));
	addVertex(Vertex(0.981, -1.0, -0.195, color2));
	addVertex(Vertex(0.981, 1.0, -0.195, color2));
	addVertex(Vertex(0.924, -1.0, -0.383, color1));
	addVertex(Vertex(0.924, 1.0, -0.383, color1));
	addVertex(Vertex(0.831, -1.0, -0.556, color1));
	addVertex(Vertex(0.831, 1.0, -0.556, color2));
	addVertex(Vertex(0.707, -1.0, -0.707, color1));
	addVertex(Vertex(0.707, 1.0, -0.707, color1));
	addVertex(Vertex(0.556, -1.0, -0.831, color1));
	addVertex(Vertex(0.556, 1.0, -0.831, color1));
	...
	addVertex(Vertex(0.383, 1.0, -0.924, color1));
	addVertex(Vertex(0.195, -1.0, -0.981, color2));
	addVertex(Vertex(0.195, 1.0, -0.981, color1));
	addVertex(Vertex(-0.0, -1.0, -1.0, color1));
	addVertex(Vertex(-0.0, 1.0, -1.0, color1));
	addVertex(Vertex(-0.195, -1.0, -0.981, color1));
	addVertex(Vertex(-0.195, 1.0, -0.981, color2));
	...
	addVertex(Vertex(-0.924, -1.0, -0.383, color1));
	addVertex(Vertex(-0.924, 1.0, -0.383, color2));
	addVertex(Vertex(-0.981, -1.0, -0.195, color1));
	addVertex(Vertex(-0.981, 1.0, -0.195, color2));
	addVertex(Vertex(-1.0, -1.0, 0.0, color2));
	addVertex(Vertex(-1.0, 1.0, 0.0, color1));
	addVertex(Vertex(-0.981, -1.0, 0.195, color1));
	...
	addVertex(Vertex(-0.195, -1.0, 0.981, color1));
	addVertex(Vertex(-0.195, 1.0, 0.981, color1));
	addVertex(Vertex(0.0, -1.0, 0.0, color1));
	addVertex(Vertex(0.0, 1.0, 0.0, color2));
	}
	// faces.
		{
	addFace(Face(1, 2, 3));
